  ...
  return (
    <div className="quiz">
      <div>
        ...
        <div id="myProgress" className="mb-2">
        ...
        <div className="container-fluid tab-content " id="pills-tabContent">
          ...
          >
            <div className="fs-5 fw-bold text-center py-4 ">Section 1</div>
            {/* {(section1_ans)?
          ...
          >
            <div className="fs-5 fw-bold text-center py-4 ">Section 2</div>
            <Quiz_answer
              score={score}
              handle={handle}
              question_count={state.question_count}
          ...
          >
            <div className="fs-5 fw-bold text-center py-4 ">Section 3</div>
            <Quiz_answer
              score={score}
              handle={handle}
              question_count={state.question_count}
          ...
          >
            <div className="fs-5 fw-bold text-center py-4 ">Section 4</div>
            <Quiz_answer
              score={score}
              handle={handle}
              question_count={state.question_count}
